...
export default function WhatHappens() {
  return (
    <section className="container py-14" aria-labelledby="what-happens-heading">
      <div className="flex flex-col md:flex-row items-center space-y-8 md:space-y-0 md:space-x-8">
        {/* Text Content */}
        <article className="w-full md:w-1/2 flex-1">
          <header>
            <p className="text-primary font-semibold">Founders Friday</p>
            <h3 id="what-happens-heading" className="text-3xl font-semibold w-60">
        ...
        <div className="w-full flex-1 relative flex justify-center">
          ...
          <figure>
            <Image
              src={Image2}
              alt="An engaging snapshot of Founders Friday activities"
              className="absolute w-[17rem] top-40 left-16 rounded-lg"
            />
            <Image
              src={Image1}
              alt="People networking at Founders Friday"
